<!-- PROCESSED: 2026-05-15 → KNOWLEDGE/agent/claude-md-rule-design/（Karpathy 原版 4 条完整 + Mnilax 新增 8 条完整 + 41%→3% 实测三档对照 + Karpathy 4 个 limitation + 试过但放弃的 6 条路径反事实证据 + 12 条完整可粘贴模板 + 两条心智模型 + 4 个 Open Questions 全部保留；self-check 加 9 道题。原文为 X 长帖整理，可保留 URL 占位 https://x.com/Mnilax/status/2053116311132155938） -->
