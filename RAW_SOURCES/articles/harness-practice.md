<!-- PROCESSED: 2026-05-13 → KNOWLEDGE/agent/harness-practice/thoughts/canonical-form-evidence.md（Rule/Skill/SubAgent/Workflow/Scripts/MCP 六概念速览表 + Rule 是软约束 vs Scripts 是硬门禁的区分 + MCP 接外部能力定位全部保留）。本文还有 12 章 JK Launcher 实战细节（章 2-12 含具体 Rule 文件写法、Workflow YAML 配置、Skills 模板等）未蒸馏——若以后做"如何从 0 搭 Harness"主题节点，回头读章 2-12。 -->
