<!-- PROCESSED: 2026-05-13 → KNOWLEDGE/agent/heuristic-learning/（HL/HS 定义 + Deep RL 对照表 + Atari 387→864 + MuJoCo Ant 6000+ / HalfCheetah 11836.7 + VizDoom 557/440 + 342 trajectories + coupling complexity + Montezuma 反例 + Robotics System 1/2 分层全部保留） -->

# Learning Beyond Gradients

*This file was converted from embedded GitHub Pages HTML to Markdown. Original article: <https://trinkle23897.github.io/learning-beyond-gradients/>. Section anchors for the tables of contents use raw HTML `<span id="…">` because GitHub-Flavored Markdown does not attach ids to arbitrary headings.*
...
1.  [The Anomaly](#en-section-1)
2.  [Heuristic Learning](#en-section-2)
3.  [Why Heuristic Learning Did Not Take Off Earlier](#en-section-3)
4.  [How Heuristic Learning Does Continual Learning](#en-section-4)
5.  [The Complexity of Heuristic Systems](#en-section-5)
6.  [The Next Paradigm?](#en-section-6)
7.  [Disclaimer](#en-disclaimer)
8.  [Acknowledgements](#en-acknowledgements)
9.  [Citation](#en-citation)
10. [Appendix: Experiment Notes and Reproduction](#en-appendix)
11. [A.1 Experiment Notes](#en-section-a-1)
12. [A.2 Reproduction Entrypoints](#en-section-a-2)
13. [Comments](#en-section-13)
...
<span id="en-appendix"></span>

## Appendix: Experiment Notes and Reproduction

The full artifact repository is <https://github.com/Trinkle23897/learning-beyond-gradients>. The commands below assume you have cloned that repo and are running them from the repository root. The GitHub Pages site only serves the article and the static files it references; the full scripts, CSVs, videos, and experiment artifacts live in the repo.
...
<span id="en-breakout"></span>

#### Breakout

Related artifacts: [heuristic_breakout.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout.py), [heuristic_breakout_trials.jsonl](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_trials.jsonl), [heuristic_breakout_trials_summary.csv](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_trials_summary.csv).
...
**Video:** [atari/breakout/heuristic_breakout_score387_tunnel0_render210x160.mp4](atari/breakout/heuristic_breakout_score387_tunnel0_render210x160.mp4)

Video artifact: [heuristic_breakout_score387_tunnel0_render210x160.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_score387_tunnel0_render210x160.mp4).
...
**Video:** [atari/breakout/heuristic_breakout_score507_stuckbreaker_render210x160.mp4](atari/breakout/heuristic_breakout_score507_stuckbreaker_render210x160.mp4)

Video artifact: [heuristic_breakout_score507_stuckbreaker_render210x160.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_score507_stuckbreaker_render210x160.mp4).
...
**Video:** [atari/breakout/heuristic_breakout_score839_fastlead_render210x160.mp4](atari/breakout/heuristic_breakout_score839_fastlead_render210x160.mp4)

Video artifact: [heuristic_breakout_score839_fastlead_render210x160.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_score839_fastlead_render210x160.mp4).
...
**Video:** [atari/breakout/heuristic_breakout_ci3985ae2_score864_render210x160.mp4](atari/breakout/heuristic_breakout_ci3985ae2_score864_render210x160.mp4)

Video artifact: [heuristic_breakout_ci3985ae2_score864_render210x160.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_ci3985ae2_score864_render210x160.mp4).
...
[![Breakout sample efficiency](atari/breakout/heuristic_breakout_sample_efficiency.png)](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_sample_efficiency.png)
...
<span id="en-ant-and-halfcheetah"></span>

#### Ant and HalfCheetah

Related artifacts: [heuristic_ant.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/heuristic_ant.py), [ant_envpool.xml](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/ant_envpool.xml), [heuristic_ant_trials.jsonl](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/heuristic_ant_trials.jsonl), [heuristic_ant_trials_summary.csv](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/heuristic_ant_trials_summary.csv), [heuristic_halfcheetah_v5.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/halfcheetah/heuristic_halfcheetah_v5.py), [heuristic_halfcheetah_v5_log.md](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/halfcheetah/heuristic_halfcheetah_v5_log.md).
...
[![Ant sample efficiency](mujoco/ant/heuristic_ant_sample_efficiency.png)](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/heuristic_ant_sample_efficiency.png)

**Video:** [mujoco/ant/heuristic_ant_mpc_default_6146_render480.mp4](mujoco/ant/heuristic_ant_mpc_default_6146_render480.mp4)

Video artifact: [heuristic_ant_mpc_default_6146_render480.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/heuristic_ant_mpc_default_6146_render480.mp4).
...
[![HalfCheetah sample efficiency](mujoco/halfcheetah/heuristic_halfcheetah_sample_efficiency.png)](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/halfcheetah/heuristic_halfcheetah_sample_efficiency.png)

<span id="en-vizdoom"></span>

#### VizDoom

Related artifacts: [heuristic_vizdoom_d1_cv.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/heuristic_vizdoom_d1_cv.py), [heuristic_vizdoom_d3_cv.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/heuristic_vizdoom_d3_cv.py), [record_vizdoom_d3_cv.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/record_vizdoom_d3_cv.py), [d1_cv_10seed_render_35fps.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/d1_cv_10seed_render_35fps.mp4), [d3_cv_best_10seed_render_35fps.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/d3_cv_best_10seed_render_35fps.mp4).
...
**Video:** [vizdoom/d1_cv_10seed_render_35fps.mp4](vizdoom/d1_cv_10seed_render_35fps.mp4)

Video artifact: [d1_cv_10seed_render_35fps.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/d1_cv_10seed_render_35fps.mp4).
...
**Video:** [vizdoom/d3_cv_best_10seed_render_35fps.mp4](vizdoom/d3_cv_best_10seed_render_35fps.mp4)

Video artifact: [d3_cv_best_10seed_render_35fps.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/d3_cv_best_10seed_render_35fps.mp4).

<span id="en-atari57"></span>

#### Atari57

Related artifacts: [atari57_prompt_template.txt](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_prompt_template.txt), [atari57_aggregate_curve_steps.csv](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_aggregate_curve_steps.csv), [atari57_env_mode_summary.csv](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_env_mode_summary.csv), [openrl_atari57_per_game_hns_comparison.csv](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/openrl_atari57_per_game_hns_comparison.csv), [atari57_hns_normalization_inferred.csv](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_hns_normalization_inferred.csv).
...
The full prompt is in [atari57_prompt_template.txt](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_prompt_template.txt). The core summary was:

> **Atari57 batch prompt summary**
...
[![Atari57 sample efficiency vs OpenRL Benchmark](atari/atari57/atari57_openrl_sample_efficiency_context.png)](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_openrl_sample_efficiency_context.png)
...
[![Atari57 per-game HNS comparison](atari/atari57/atari57_per_game_hns_comparison.png)](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_per_game_hns_comparison.png)
...
<span id="en-montezuma"></span>

#### Montezuma

Related artifacts: [heuristic_montezuma.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/heuristic_montezuma.py), [heuristic_montezuma_state_graph_search.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/heuristic_montezuma_state_graph_search.py), [heuristic_montezuma_400_policy.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/heuristic_montezuma_400_policy.py), [heuristic_montezuma_400_macros.json](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/heuristic_montezuma_400_macros.json), [heuristic_montezuma_400_metadata.json](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/heuristic_montezuma_400_metadata.json).
...
**Video:** [atari/montezuma/montezuma_400_render_seed10001_h264.mp4](atari/montezuma/montezuma_400_render_seed10001_h264.mp4)

Video artifact: [montezuma_400_render_seed10001_h264.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/montezuma_400_render_seed10001_h264.mp4).
...
<span id="en-pong-21"></span>

#### Pong 21

Reproduction entrypoint: [heuristic_pong.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/pong/heuristic_pong.py).
...
<span id="en-breakout-intermediate-nodes"></span>
...
**Reproduce 387: return the ball, but do not break the loop**
...
**Reproduce 507: add stuck-loop perturbation**
...
**Reproduce 839: handle fast low balls**
...
<span id="en-breakout-864"></span>

#### Breakout 864

Reproduction entrypoint: [heuristic_breakout.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout.py).
...
<span id="en-ant-default-mpc-policy"></span>

#### Ant Default MPC Policy

Reproduction entrypoints: [heuristic_ant.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/heuristic_ant.py), [ant_envpool.xml](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/ant_envpool.xml).
...
<span id="en-halfcheetah-staged-tree-mpc"></span>

#### HalfCheetah Staged-Tree MPC

Reproduction entrypoint: [heuristic_halfcheetah_v5.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/halfcheetah/heuristic_halfcheetah_v5.py).
...
<span id="en-vizdoom-d1-basic-cv-policy"></span>

#### VizDoom D1 Basic CV Policy

Reproduction entrypoint: [heuristic_vizdoom_d1_cv.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/heuristic_vizdoom_d1_cv.py).
...
<span id="en-vizdoom-d3-battle-cv-policy"></span>

#### VizDoom D3 Battle CV Policy

Reproduction entrypoints: [heuristic_vizdoom_d3_cv.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/heuristic_vizdoom_d3_cv.py), [record_vizdoom_d3_cv.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/record_vizdoom_d3_cv.py).
...
<span id="en-montezuma-400-point-replay"></span>

#### Montezuma 400-Point Replay

Reproduction entrypoint: [heuristic_montezuma_400_policy.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/heuristic_montezuma_400_policy.py).
...
<span id="en-section-13"></span>

## Comments

**Comments (GitHub)** (`Trinkle23897/learning-beyond-gradients`, language: `en`): [Open a comment issue on GitHub](https://github.com/Trinkle23897/learning-beyond-gradients/issues/new?title=Comment%3A%20Learning%20Beyond%20Gradients).
...
1.  [异常现象](#zh-section-1)
2.  [Heuristic Learning](#zh-section-2)
3.  [为什么 Heuristic Learning 以前没发展起来](#zh-section-3)
4.  [Heuristic Learning 怎么做 Continual Learning](#zh-section-4)
5.  [Heuristic System 的复杂度](#zh-section-5)
6.  [下一个范式？](#zh-section-6)
7.  [免责声明](#zh-disclaimer)
8.  [致谢](#zh-acknowledgements)
9.  [引用](#zh-citation)
10. [附录：实验过程和复现入口](#zh-appendix)
11. [A.1 实验过程简述](#zh-section-a-1)
12. [A.2 复现入口](#zh-section-a-2)
13. [评论](#zh-section-13)
...
<span id="zh-breakout"></span>

#### Breakout

相关 artifact：[heuristic_breakout.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout.py)、[heuristic_breakout_trials.jsonl](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_trials.jsonl)、[heuristic_breakout_trials_summary.csv](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_trials_summary.csv)。
...
视频 artifact：[heuristic_breakout_score387_tunnel0_render210x160.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_score387_tunnel0_render210x160.mp4)。
...
视频 artifact：[heuristic_breakout_score507_stuckbreaker_render210x160.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_score507_stuckbreaker_render210x160.mp4)。
...
视频 artifact：[heuristic_breakout_score839_fastlead_render210x160.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_score839_fastlead_render210x160.mp4)。
...
视频 artifact：[heuristic_breakout_ci3985ae2_score864_render210x160.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_ci3985ae2_score864_render210x160.mp4)。
...
[![Breakout 样本效率](atari/breakout/heuristic_breakout_sample_efficiency.png)](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout_sample_efficiency.png)

这里不能写成“纯图像从零 14.5K 步到满分”。真实过程是：Codex 先在 RAM 版本里摸出了几何控制、打破循环、后期收偏移这些结构；等结构稳定以后，再把状态读取层从 RAM 换成 RGB 检测器。纯图像的 `14.5K` 是迁移预算。

<span id="zh-ant-halfcheetah"></span>

#### Ant 和 HalfCheetah

相关 artifact：[heuristic_ant.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/heuristic_ant.py)、[ant_envpool.xml](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/ant_envpool.xml)、[heuristic_ant_trials.jsonl](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/heuristic_ant_trials.jsonl)、[heuristic_ant_trials_summary.csv](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/heuristic_ant_trials_summary.csv)、[heuristic_halfcheetah_v5.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/halfcheetah/heuristic_halfcheetah_v5.py)、[heuristic_halfcheetah_v5_log.md](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/halfcheetah/heuristic_halfcheetah_v5_log.md)。
...
[![Ant 样本效率](mujoco/ant/heuristic_ant_sample_efficiency.png)](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/heuristic_ant_sample_efficiency.png)

**Video:** [mujoco/ant/heuristic_ant_mpc_default_6146_render480.mp4](mujoco/ant/heuristic_ant_mpc_default_6146_render480.mp4)

视频 artifact：[heuristic_ant_mpc_default_6146_render480.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/heuristic_ant_mpc_default_6146_render480.mp4)。
...
[![HalfCheetah 样本效率](mujoco/halfcheetah/heuristic_halfcheetah_sample_efficiency.png)](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/halfcheetah/heuristic_halfcheetah_sample_efficiency.png)

<span id="zh-vizdoom"></span>

#### VizDoom

相关 artifact：[heuristic_vizdoom_d1_cv.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/heuristic_vizdoom_d1_cv.py)、[heuristic_vizdoom_d3_cv.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/heuristic_vizdoom_d3_cv.py)、[record_vizdoom_d3_cv.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/record_vizdoom_d3_cv.py)、[d1_cv_10seed_render_35fps.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/d1_cv_10seed_render_35fps.mp4)、[d3_cv_best_10seed_render_35fps.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/d3_cv_best_10seed_render_35fps.mp4)。
...
视频 artifact：[d1_cv_10seed_render_35fps.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/d1_cv_10seed_render_35fps.mp4)。
...
视频 artifact：[d3_cv_best_10seed_render_35fps.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/d3_cv_best_10seed_render_35fps.mp4)。

<span id="zh-atari57"></span>

#### Atari57

相关 artifact：[atari57_prompt_template.txt](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_prompt_template.txt)、[atari57_aggregate_curve_steps.csv](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_aggregate_curve_steps.csv)、[atari57_env_mode_summary.csv](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_env_mode_summary.csv)、[openrl_atari57_per_game_hns_comparison.csv](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/openrl_atari57_per_game_hns_comparison.csv)、[atari57_hns_normalization_inferred.csv](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_hns_normalization_inferred.csv)。
...
完整提示词放在 [atari57_prompt_template.txt](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_prompt_template.txt)。核心摘要是：
...
[![Atari57 样本效率对比 OpenRL Benchmark](atari/atari57/atari57_openrl_sample_efficiency_context.png)](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_openrl_sample_efficiency_context.png)
...
[![Atari57 每个游戏 HNS 对比](atari/atari57/atari57_per_game_hns_comparison.png)](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/atari57/atari57_per_game_hns_comparison.png)
...
<span id="zh-montezuma"></span>

#### Montezuma

相关 artifact：[heuristic_montezuma.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/heuristic_montezuma.py)、[heuristic_montezuma_state_graph_search.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/heuristic_montezuma_state_graph_search.py)、[heuristic_montezuma_400_policy.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/heuristic_montezuma_400_policy.py)、[heuristic_montezuma_400_macros.json](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/heuristic_montezuma_400_macros.json)、[heuristic_montezuma_400_metadata.json](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/heuristic_montezuma_400_metadata.json)。
...
视频 artifact：[montezuma_400_render_seed10001_h264.mp4](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/montezuma_400_render_seed10001_h264.mp4)。
...
<span id="zh-section-a-2"></span>

### A.2 复现入口

下面这些命令默认在本文所在目录运行，依赖已经按 `requirements.txt` 装好，用来检查前面提到的几个代表性结果。

<span id="zh-pong-21"></span>

#### Pong 21

复现入口：[heuristic_pong.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/pong/heuristic_pong.py)。
...
<span id="zh-breakout-intermediate-nodes"></span>
...
<span id="zh-breakout-864"></span>

#### Breakout 864

复现入口：[heuristic_breakout.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/breakout/heuristic_breakout.py)。
...
<span id="zh-ant-default-mpc-policy"></span>

#### Ant 默认 MPC 策略

复现入口：[heuristic_ant.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/heuristic_ant.py)、[ant_envpool.xml](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/ant/ant_envpool.xml)。
...
<span id="zh-halfcheetah-staged-tree-mpc"></span>

#### HalfCheetah staged-tree MPC

复现入口：[heuristic_halfcheetah_v5.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/mujoco/halfcheetah/heuristic_halfcheetah_v5.py)。
...
<span id="zh-vizdoom-d1-basic-cv-policy"></span>

#### VizDoom D1 Basic CV 策略

复现入口：[heuristic_vizdoom_d1_cv.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/heuristic_vizdoom_d1_cv.py)。
...
<span id="zh-vizdoom-d3-battle-cv-policy"></span>

#### VizDoom D3 Battle CV 策略

复现入口：[heuristic_vizdoom_d3_cv.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/heuristic_vizdoom_d3_cv.py)、[record_vizdoom_d3_cv.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/vizdoom/record_vizdoom_d3_cv.py)。
...
<span id="zh-montezuma-400-point-replay"></span>

#### Montezuma 400 分回放

复现入口：[heuristic_montezuma_400_policy.py](https://github.com/Trinkle23897/learning-beyond-gradients/blob/main/atari/montezuma/heuristic_montezuma_400_policy.py)。
...
<span id="zh-section-13"></span>

## 评论

**Comments (GitHub)** (`Trinkle23897/learning-beyond-gradients`, language: `zh`): [Open a comment issue on GitHub](https://github.com/Trinkle23897/learning-beyond-gradients/issues/new?title=Comment%3A%20Learning%20Beyond%20Gradients).
