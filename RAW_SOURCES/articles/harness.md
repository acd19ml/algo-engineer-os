<!-- PROCESSED: 2026-05-13 → KNOWLEDGE/agent/harness-practice/thoughts/canonical-form-evidence.md（三次范式跃迁 + Hashimoto 定义 + 四种失败模式 + 上下文 Sweet Spot 40% + 四根支柱 + JK Launcher 24.86%→90.54% + 四要素 + .harness/ 目录 + 10 阶段 pipeline + 三层上下文加载 + Entropy GC + 范式转移全部保留） -->
