<!-- PROCESSED: 2026-05-13 → KNOWLEDGE/agent/harness-practice/thoughts/canonical-form-evidence.md（控制论坐标 + 维纳 1948 + Hashimoto 反馈环全部保留） -->
...
4月17日
15
看起来就是工作流，为什么要对一回事的东西重复造词。skill啥的只是md文档而已最早大家也会写rule.md，让这帮人吹出花了都
...
4月17日
4
“然而真正的难题是把人类独有的知识变成AI可读的东西”---大部分人类独有的知识也都来自互联网（搜索引擎 github等），而这些AI都已经具备，所以Harness Engineering会陆续出现更多更好的模版和标准，对于大部分人来说找到合适的模版，并稍以调整就可用于自己的业务了。门槛越来越低了，人在这个过程中的也就越来越不重要了，解放全人类吧！

肉肉
福建
4月17日
4
一早看到这样的好文神清气爽，比起一大堆的概念术语技巧啥的文章好太多，层次高得多，立刻去下单买书先。

明天，你好
湖北
4月17日
3
从控制论的角度来看AI 的发展，类比工业发展到软件工程演进，提供了一个新的思考角度，感谢作者

Galen
湖南
4月30日
2
“反馈控制”是一种指导思想，目的是减小不确定性，促使系统向目标状态转移。因为是思想，所以几乎往哪里套都可以，但应用场景不同，需要考虑的工具天差地别。Harness里可以抽象出必要的基本组件：控制器 被控对象 传感器，但是否能像传统控制基于数值误差进行相对准确的调控？这点还看不出来迹象，有懂的朋友解释一下吗？
...
4月17日
2
实践中越来越重视写md了，甚至会做预实验：先开发一个垃圾，然后抛弃这个代码库，以更明确的需求重新写一个md，再进行正式AI辅助开发。markdown将会成为唯一的编程语言。
...
4月20日
1
一切花架子都是模型能力不足的补丁。模型够强，对话就够了。

茅弘毅
广东
4月17日
1
未来所有行业人员都要程序员化，为AI制定工作环境

大星星
北京
4月17日
1
人类总喜欢归因，因有时候没那么神奇，就是很普通，人自身就是这样一个载体

阿锴_kim
广东
3天前
在Ai完善前会出现很多中间概念，比如通过注释提示Ai、Spec、Skill、Harness，随着Ai完善这些都会成为历史
...
广东
4月30日
个人觉得尝试去控制ai输出由人来评估的代码也是死路一条，这个瓶颈太明显了。最终可行的办法就是说清楚需求，然后全部交给ai，如何编码，用什么规范会最终会内化成ai自己的能力不需要人去关心。现在很多的代码规范其实是建立在需要人去维护的基础上，的。人最终能验证的就是程序有没有满足自己的需求。

风声不存在
湖北
4月27日
层次上来了，关键是如何构建这样的环境呢？
有一个点不要忽略，有了AI技术债堆积的速度快了，但是解决的速度也很快，堆积成山，几个小时就重构完了

fuhao
江苏
4月20日
PDCA OODA
果然核心的“道”往往是可以迁移应用到很多场景的。
...
江苏
4月18日
巧了，最近在看金观涛的《历史的巨镜》，打算尽量搜集他的所有书籍和公开知识
...
河北
4月17日
控制工程专业转码，到agent时代，发现我又回到了熟悉的概念

chen xu
北京
4月17日
既然当前时代的程序员的主要工作是设计AI的工作环境，那么让AI直接设计这个工作环境呢，AI套娃了属于是。
